...
### 8.1 ATR 21EMA
現在価格と `EMA21 Low / 21EMA帯` との距離を ATR 基準で評価する。
...
#### 初期良好ゾーン
- `<= +3.0 ATR`
- これを大きく超える場合は late entry 扱い

### 8.4 パラメータ
- `atr_21ema_good_min = -0.5`
- `atr_21ema_good_max = 1.0`
...
### 9.1 定義
- `ema21_low_pct = (entry_or_current_price - ema21_low) / entry_or_current_price * 100`
