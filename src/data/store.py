...
class DataSnapshotStore:
    ...
    def _save_market_result(self, date_key: str, market_result: Any, metadata: dict[str, Any], *, radar_result: Any | None = None) -> None:
        payload = {
            ...
            "breadth_momentum_summary": dict(getattr(market_result, "breadth_momentum_summary", {})),
            "breadth_internal_summary": dict(getattr(market_result, "breadth_internal_summary", {})),
            ...
            "volatility_term_structure": dict(getattr(market_result, "volatility_term_structure", {})),
