...
| Output | `bool` |
| Direct scan config | `vcs_52_high_vcs_min`, `vcs_52_high_rs21_min`, `vcs_52_high_dist_max` |

## Evaluation Context

- Evaluated on one latest row after `enrich_with_scan_context()`.
- Reads a precomputed VCS score, RS score, and 52-week-high distance field.
...
|---|---|---|
| `scan.vcs_52_high_vcs_min` | `60.0` | minimum VCS score |
| `scan.vcs_52_high_rs21_min` | `60.0` | minimum raw RS21 threshold, using a strict `>` comparison |
| `scan.vcs_52_high_dist_max` | `-15.0` | lower bound for proximity to the 52-week high |
