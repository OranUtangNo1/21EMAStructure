...
| Output | `bool` |
| Direct scan config | `vcs_52_low_vcs_min`, `vcs_52_low_rs21_min`, `vcs_52_low_dist_max` |

## Evaluation Context

- Evaluated on one latest row after `enrich_with_scan_context()`.
- Reads a precomputed VCS score, RS score, and 52-week-low distance field.
...
| `scan.vcs_52_low_rs21_min` | `60.0` | minimum raw RS21 threshold, using a strict `>` comparison |
